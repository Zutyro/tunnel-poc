...
if __name__ == '__main__':
    ...
    tunnel_interface = '192.168.0.2'  # IP of attacked host, needs to have a tunnel configured
    tunnel_exit = '2001::1'  # IP of the attacked host, where tunnel traffic is directed to
    victim_ip = '2001::2'  # Victim in the tunneled network, where you want the tunneled traffic to be sent
